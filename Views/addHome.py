...
class home():
    ...
    def __init__(self):
        ...
        lbl = backController.create_label2('Agregar Propiedad', self.window)#Titulo y estilos
        ...
        self.txt4.set(2)
        self.radio1=Radiobutton(self.window,text="Varon", variable=self.txt4, value=1)
        self.radio1.grid(column=5, row=2)
        self.radio2=Radiobutton(self.window,text="Mujer", variable=self.txt4, value=2)
        self.radio2.grid(column=2, row=1)
        self.boton1=Button(self.window, text="Mostrar seleccionado", command=lambda: addController.mostrarseleccionado(self))
        self.boton1.grid(column=6, row=5)
        self.label1=Label(self.window,text="opcion seleccionada")
        ...
        self.txt4.insert(0, "Empresa de seguridad") #Implementacion de placeholder
        ...
        self.txt5.insert(0, "Tipo de propiedad") #Implementacion de placeholder
